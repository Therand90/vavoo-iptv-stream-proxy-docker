...
| `VAVOO_VARIANT_QUARANTINE_SECONDS` | `300` | Quarantaine temporaire appliquée à une variante après une erreur ordinaire ou une playlist périmée. |
...
| `VAVOO_QUALITY_RANKING_ENABLED` | `true` | Classe les variantes à partir de la résolution, du framerate, du débit et des signaux de boucle lorsqu’aucune variante active saine n’existe. |
...
- une variante active saine ne change pas uniquement parce qu’une autre obtient une meilleure qualité technique.
